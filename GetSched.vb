...
Public Class GetSched
    ...
    Private Function CalculateFollowUpDates(ByVal appointmentDate As DateTime) As List(Of DateTime)
        ...
        For i As Integer = 0 To 2
            ...
            Dim followUpDate As DateTime = appointmentDate.AddDays(30 * (i + 1))


            followUpDate = New DateTime(followUpDate.Year, followUpDate.Month, followUpDate.Day, 9, 0, 0) ' Set to 9:00 AM
            If followUpDate.Hour >= 17 Then
